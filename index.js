...
if (process.argv.slice(2).length === 0 || args.h || args.help) {
  console.log(`
pingdom-2-checkly --pingdomApiKey <pingdom APi key> --checklyApiKey <checkly API key>

Where <pingdom APi key> is your api key
and
<checkly API key> is the checkly api key
    `);
     process.exit(0)
}
  ...
  if (!args.pingdomApiKey) {
    console.log('please provide the --pingdomApiKey argument or type pingdom-2-checkly --help')
    process.exit(0)
  }
